...
Public Class PolygonTest
    ...
    Public ReadOnly Property Points As SKPoint()
        Get
            Return _points
        End Get
    End Property

    Public Sub New(points As IEnumerable(Of SKPoint))
    ...
    Public Sub New(points As SKPoint(), N As Integer)
        Me.New(points.Take(N))
    End Sub

    Public Function PointInPolygonTest(p As SKPoint) As PointInPolygonResult
        Dim parity = True
    ...
    Private Function GetEdgeType(p As SKPoint, v1 As SKPoint, v2 As SKPoint) As EdgeType
    ...
    Private Function Classify(p As SKPoint, v1 As SKPoint, v2 As SKPoint) As PointOverEdge
