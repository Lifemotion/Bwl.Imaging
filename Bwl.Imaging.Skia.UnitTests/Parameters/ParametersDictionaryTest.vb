...
Public Class ParametersDictionaryTest
    ...
    Public Sub ParametersDictionaryEqualityTest1()
        ...
        Dim paramsJson1 = JsonSerializer.Serialize(params1)

        Dim params2 = JsonSerializer.Deserialize(Of ParametersDictionary)(paramsJson1)
        Dim paramsJson2 = JsonSerializer.Serialize(params2)

        Assert.That(paramsJson1, [Is].EqualTo(paramsJson2))
    End Sub
    ...
    Public Sub ParametersDictionaryEqualityTest2()
        ...
        Dim params2 = JsonSerializer.Deserialize(Of ParametersDictionaryList)(paramsJson1)
        Dim paramsJson2 = JsonSerializer.Serialize(params2)
