...
namespace Bwl.Imaging
{
    ...
    public static class VectorTools
    {
        ...
        /// Тест: полигон пустой?
        /// </summary>
        public static bool PolygonIsEmpty(PointF[] polygon)
        {
            if (polygon.Length > 3)
            {
        ...
        /// </summary>
        public static PointF NormalizeVector(PointF vector, float targetLen = 1.0f)
        {
            ...
            return new PointF((float)xn, (float)yn);
        }

        /// <summary>
        /// Проверка на нахождение вектора между векторами-границами
        /// </summary>
        public static bool VectorInBounds(PointF vector, PointF vectorBound1, PointF vectorBound2, double tol = 0.017d)
        {
        ...
        /// </summary>
        public static double AngleBetweenVectors(PointF vector1, PointF vector2)
        {
        ...
        /// </summary>
        public static double AnglePathBetweenVectors(PointF vector1, PointF vector2)
        {
