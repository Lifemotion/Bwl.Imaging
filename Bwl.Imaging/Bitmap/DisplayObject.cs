...
namespace Bwl.Imaging
{
    ...
    public class DisplayObject : ICloneable
    {
        ...
        public DisplayObject(string id, Color color, object obj)
        {
            ID = id;
            Color = color;
            DrawObject = obj;
        ...
        public DisplayObject(string id, Color color, object obj, bool isSelectable, bool isMoveable)
        {
            ID = id;
            Color = color;
            DrawObject = obj;
