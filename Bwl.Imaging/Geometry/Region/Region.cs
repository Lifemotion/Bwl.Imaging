...
namespace Bwl.Imaging
{
    ...
    public class Region : Polygon, ICloneable
    {
        ...
        public Region() : base(true, new[] { new PointF(), new PointF(), new PointF(), new PointF() }) // Как Tetragon
        {
            ID = Guid.NewGuid().ToString();
        }

        public Region(PointF[] points) : base(true, points)
        {
            ID = Guid.NewGuid().ToString();
        }

        public Region(string id) : base(true, new[] { new PointF(), new PointF(), new PointF(), new PointF() }) // Как Tetragon
        {
            ID = id;
        }

        public Region(string id, PointF[] points) : base(true, points)
        {
            ID = id;
        }
        ...
        public virtual Region CloneWithNewPoints(PointF[] points)
        {
