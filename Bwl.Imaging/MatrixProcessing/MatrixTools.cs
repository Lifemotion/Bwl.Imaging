...
namespace Bwl.Imaging
{
    ...
    /// </summary>
        public static Rectangle RectangleAlign(Rectangle rect, int align = 4)
        {
            int rX1 = rect.X;
            int rY1 = rect.Y;
    ...
    /// </summary>
        public static GrayMatrix GrayMatrixSubRect(GrayMatrix img, Rectangle rect)
        {
            var result = new GrayMatrix(rect.Width, rect.Height);
            int[] imgGray = img.Gray;
            int[] resultGray = result.Gray;
            int offsetImg = rect.X + rect.Y * img.Width;
            int offsetRes = 0;
    ...
    /// </summary>
        public static RGBMatrix RGBMatrixSubRect(RGBMatrix img, Rectangle rect)
        {
