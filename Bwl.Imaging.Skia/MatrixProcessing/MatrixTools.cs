...
public static class MatrixTools
{
    ...
    /// </summary>
    public static GrayMatrix GetGrayMatrix(this SKBitmapInfo bi)
    {
        return bi.GetClonedBmp().ToGrayMatrix();
    }

    /// <summary>
    /// Получение полноцветной матрицы на основе BitmapInfo
    /// </summary>
    public static RGBMatrix GetRGBMatrix(this SKBitmapInfo bi)
    {
        return bi.GetClonedBmp().ToRgbMatrix();
    }
